...
namespace System.Reflection
{
    ...
    internal static class ReflectionExtensions
    {
        ...
        public static TypeInfo _GetTypeInfo(this Type type)
        {
            return new TypeInfo(type);
        }

        public static TypeInfo _CreateTypeInfo(this TypeBuilder type)
        {
            return new TypeInfo(type.CreateType());
        }

        public static MethodInfo _GetRuntimeMethod(this Type type, string name, Type[] types)
        {
            return type.GetMethod(name, types); // no use flags.
        }

        public static MethodInfo _GetRuntimeMethod(this Type type, string name)
        {
        ...
        public static PropertyInfo _GetRuntimeProperty(this Type type, string name)
        {
            return type.GetProperty(name, flags);
        }

        public static PropertyInfo[] _GetRuntimeProperties(this Type type)
        {
        ...
        public static FieldInfo[] _GetRuntimeFields(this Type type)
        {
