    ...
    internal static class DynamicGenericResolverGetFormatterHelper
    {
        ...
        internal static object GetFormatter(Type t)
        {
            ...
            else if (ti.IsGenericType)
            {
                ...
                var genericTypeInfo = genericType._GetTypeInfo();
                ...
                else if (isNullable && nullableElementType._GetTypeInfo().IsConstructedGenericType() && nullableElementType.GetGenericTypeDefinition() == typeof(KeyValuePair<,>))
                {
                ...
                else if (isNullable && nullableElementType._GetTypeInfo().IsConstructedGenericType() && nullableElementType.GetGenericTypeDefinition() == typeof(ArraySegment<>))
                {
                ...
                else
                {
                    ...
                    // generic collection
                          ...
                          && ti.ImplementedInterfaces.Any(x => x._GetTypeInfo().IsConstructedGenericType() && x.GetGenericTypeDefinition() == typeof(ICollection<>))
                    ...
                    // generic dictionary
                          ...
                          && ti.ImplementedInterfaces.Any(x => x._GetTypeInfo().IsConstructedGenericType() && x.GetGenericTypeDefinition() == typeof(IDictionary<,>))
                          && ti.DeclaredConstructors.Any(x => x.GetParameters().Length == 0))
                    {
